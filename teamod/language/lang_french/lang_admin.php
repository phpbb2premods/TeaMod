...
$lang['Cookie_settings'] = 'Options des Cookie, rep.rapide, hypercell';
$lang['Hyperce'] = 'Hypercell onClick';
...
$lang['Finish_team'] = 'Poursuivre l\'Installation avec CH 2.1.4';
...
$lang['Inst_Step_2'] = 'Votre compte d\'administration a été créé. A ce point, l\'installation de base est terminée. Vous allez être redirigé vers une nouvelle page <u>qui installera Catégorie Hiérarchie 2,1,4 automatiquement</u>. Veuillez vous assurer de d\'avoir <b>EFFACE les réperoires CONTRIB et INSTALL</b> avant de cliquer sur finir l\'installation. Merci d\'avoir choisi phpBB 2 et la prémode TeaMod V1.2 d\'EzCom.';
...
//-- mod : hypercell class -----------------------------------------------------
//-- add
$lang['Hypercell_onclick'] = 'Activer l\'événement Hypercell onClick';
//-- fin mod : hypercell class -------------------------------------------------
// Autologin Keys - added 2.0.18 
$lang['Allow_autologin'] = 'Permettre les connexions automatiques'; 
$lang['Allow_autologin_explain'] = 'Détermine si les utilisateurs sont autorisés ˆ choisir d\'être automatiquement connecté lors de leur visite sur le forum'; 
