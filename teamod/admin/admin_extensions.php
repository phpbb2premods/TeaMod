...
*/
//-- add
	$module['Attachments_Extensions']['Extension_control'] = $filename . '?mode=extensions';
	$module['Attachments_Extensions']['Extension_group_manage'] = $filename . '?mode=groups';
	$module['Attachments_Extensions']['Forbidden_extensions'] = $filename . '?mode=forbidden';
$lang['Attachments_Extensions'] = $lang['Extensions'];
...
//-- mod : categories hierarchy ------------------------------------------------
//-- add
		$sql .= ' AND forum_type = \'' . POST_FORUM_URL . '\'';
//-- fin mod : categories hierarchy --------------------------------------------
		if (!($result = $db->sql_query($sql)))
		{
...
//-- mod : categories hierarchy ------------------------------------------------
//-- add
	$sql .= ' WHERE forum_type = \'' . POST_FORUM_URL . '\'';
//-- fin mod : categories hierarchy --------------------------------------------
...
//-- mod : categories hierarchy ------------------------------------------------
//-- add
	// no restrictions based on requirements
	$sql = 'SELECT forum_id, forum_name
				FROM ' . FORUMS_TABLE . '
				WHERE forum_type = \'' . POST_FORUM_URL . '\'';
//-- fin mod : categories hierarchy --------------------------------------------
