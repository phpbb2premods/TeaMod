...
//-- add
		...
		{
			list($user_qp, $user_qp_show, $user_qp_subject, $user_qp_bbcode, $user_qp_smilies, $user_qp_more) = explode('-', $config->data['users_qp_settings']);
		}
...
//-- mod : hypercell class -----------------------------------------------------
//-- add
$hypercell_onclick_yes = ( $new['hypercell_onclick'] ) ? "checked=\"checked\"" : "";
$hypercell_onclick_no = ( !$new['hypercell_onclick'] ) ? "checked=\"checked\"" : "";
...
//-- add
$qp_displays = array(
	array('qp_title' => $user->lang('qp_enable'), 'qp_desc' => $user->lang('qp_enable_explain'), 'qp_user_var' => 'user_qp', 'qp_anon_var' => 'anon_qp'),
	array('qp_title' => $user->lang('qp_show'), 'qp_desc' => $user->lang('qp_show_explain'), 'qp_user_var' => 'user_qp_show', 'qp_anon_var' => 'anon_qp_show'),
	array('qp_title' => $user->lang('qp_subject'), 'qp_desc' => $user->lang('qp_subject_explain'), 'qp_user_var' => 'user_qp_subject', 'qp_anon_var' => 'anon_qp_subject'),
	array('qp_title' => $user->lang('qp_bbcode'), 'qp_desc' => $user->lang('qp_bbcode_explain'), 'qp_user_var' => 'user_qp_bbcode', 'qp_anon_var' => 'anon_qp_bbcode'),
	array('qp_title' => $user->lang('qp_smilies'), 'qp_desc' => $user->lang('qp_smilies_explain'), 'qp_user_var' => 'user_qp_smilies', 'qp_anon_var' => 'anon_qp_smilies'),
	array('qp_title' => $user->lang('qp_more'), 'qp_desc' => $user->lang('qp_more_explain'), 'qp_user_var' => 'user_qp_more', 'qp_anon_var' => 'anon_qp_more'),
);
...
//-- add
	...
	"L_QP_USER" => $user->lang('qp_user'),
	"L_QP_ANON" => $user->lang('qp_anon'),
//-- fin mod : quick post es ---------------------------------------------------
//-- mod : hypercell class -----------------------------------------------------
//-- add
	"L_HYPERCELL_ONCLICK" => $lang['Hypercell_onclick'],
	"HYPERCELL_ONCLICK_YES" => $hypercell_onclick_yes,
	"HYPERCELL_ONCLICK_NO" => $hypercell_onclick_no,
//-- fin mod : hypercell class -------------------------------------------------
