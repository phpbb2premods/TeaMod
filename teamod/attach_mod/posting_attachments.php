...
//-- mod : categories hierarchy ------------------------------------------------
//-- add
			$template->set_filenames(array('add_attachment_body' => 'add_attachment_body.tpl'));
			$template->assign_var_from_handle('ADD_ATTACHMENT_BODY', 'add_attachment_body');
//-- fin mod : categories hierarchy --------------------------------------------
		}
...
//-- mod : categories hierarchy ------------------------------------------------
//-- add
			$template->set_filenames(array('posted_attachments_body' => 'posted_attachments_body.tpl'));
			$template->assign_var_from_handle('POSTED_ATTACHMENTS_BODY', 'posted_attachments_body');
//-- fin mod : categories hierarchy --------------------------------------------
		}
