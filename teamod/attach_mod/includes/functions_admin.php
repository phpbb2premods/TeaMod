...
* @version $Id: functions_admin.php,v 1.2 2005/11/06 15:37:12 acydburn Exp $
...
//-- mod : categories hierarchy ------------------------------------------------
//-- add
	// what about forums searching ?
	$search_forum = intval($search_forum);
	if ( $search_forum > 0 )
	{
		$where_sql[] = 'p.forum_id = ' . $search_forum;
	}
