...
<form action="{S_PROFILE_ACTION}" {S_FORM_ENCTYPE} method="post">
	<tr>
		<td valign="top">
				...
				<tr>
					<td class="row1" height="25">
						...
						<table width="100%" cellpadding="2" cellspacing="0" border="0">
							...
							<!-- END switch_avatar_block -->
							<tr>
								<td width="10" align="right"><div id="qpesinfo_flag" class="gensmall">&raquo;</div></td>
								<td nowrap="nowrap" onMouseOver="this.style.cursor='pointer'; this.style.fontWeight='bold';" onMouseOut="this.style.cursor='pointer'; this.style.fontWeight='normal';" onClick="dom_menu.set('qpesinfo'); return false;"><div id="qpesinfo_opt"><a href="javascript:dom_menu.set('qpesinfo');" class="gensmall">{L_QP_MENU}</a></div></td>
							</tr>
							<tr>
			...
			<table id="avatarinfo_cur" style="display:none" class="forumline" width="100%" cellpadding="4" cellspacing="1" border="0">
				<tr>
		...
		<td valign="top" width="100%">
			<table id="reginfo" class="forumline" width="100%" cellpadding="3" cellspacing="1" border="0">
				<tr> 
					<th class="thHead" height="25" valign="middle" colspan="2">{L_REGISTRATION_INFO}</th>
				</tr>
				<tr> 
				...
				<tr>
					<td class="row1" align="center" colspan="2"><span class="gensmall">{L_CONFIRM_CODE_IMPAIRED}</span><br /><br />{CONFIRM_IMG}<br /><br /></td>
				</tr>
				<tr> 
				...
				<!-- END switch_confirm -->
				<tr> 
					<td class="catBottom" height="28" align="center" colspan="2"><input type="submit" name="submit" value="{L_SUBMIT}" class="mainoption" />&nbsp;&nbsp;<input type="reset" value="{L_RESET}" name="reset" class="liteoption" />
					</td>
				</tr>
			</table>

			<table id="profileinfo" class="forumline" width="100%" cellpadding="3" cellspacing="1" border="0">
				<tr>
					<th class="thHead" height="25" valign="middle" colspan="2">{L_PROFILE_INFO}</th>
				</tr>
				<tr> 
...
<table id="qpesinfo" border="0" cellpadding="3" cellspacing="1" width="100%" class="forumline">
  <tr>
	<th class="thHead" colspan="2" height="25" valign="middle">{L_QP_SETTINGS}</th>
  </tr>
  <!-- BEGIN quick_post -->
  <tr>
	<td class="row1" width="38%"><span class="gen">{quick_post.L_QP_TITLE}</span><br /><span class="gensmall">{quick_post.L_QP_DESC}</span></td>
	<td class="row2">
		<input type="radio" name="{quick_post.QP_VAR}" value="1" {quick_post.QP_YES} />
		<span class="gen">{L_YES}</span>&nbsp;&nbsp;
		<input type="radio" name="{quick_post.QP_VAR}" value="0" {quick_post.QP_NO} />
  ...
  <tr>
	<td class="catBottom" colspan="2" align="center" height="28"><input type="submit" name="submit" value="{L_SUBMIT}" class="mainoption" />&nbsp;&nbsp;<input type="reset" value="{L_RESET}" name="reset" class="liteoption" />
			...
			<table id="prefinfo" class="forumline" width="100%" cellpadding="3" cellspacing="1" border="0">
				<tr>
					<th class="thHead" height="25" colspan="2" valign="middle">{L_PREFERENCES}</th>
				</tr>
				<tr> 
			...
			<!-- BEGIN switch_avatar_block -->
			<table id="avatarinfo" class="forumline" width="100%" cellpadding="3" cellspacing="1" border="0">
				<tr>
					<th class="thHead" height="12" valign="middle" colspan="2">{L_AVATAR_PANEL}</th>
				</tr>
