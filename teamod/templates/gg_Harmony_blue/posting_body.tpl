...
<table width="100%" align="center" cellpadding="0" cellspacing="0" border="0">
	<tr>
		<td width="100%" align="center" valign="top"> 
			<table height="40" cellpadding="2" cellspacing="2" border="0">
				<tr valign="middle">
					<td>{INBOX_IMG}</td>
...
<table width="100%" cellpadding="2" cellspacing="2" border="0">
	<tr>
		<td align="left" valign="bottom"><span class="mainPost">
			<a class="mainPost" href="{U_TITLE}">{TITLE}</a>
	</span></td>
</tr>
</table>
				...
				<tr>
					<td valign="middle" align="center"><br />
						<table width="100" cellspacing="0" cellpadding="5" border="0">
							...
							<tr align="center">
								<td colspan="{S_SMILIES_COLSPAN}"><span class="topictitle"><a href="{U_MORE_SMILIES}" onclick="window.open('{U_MORE_SMILIES}', '_phpbbsmilies', 'HEIGHT=220,resizable=yes,scrollbars=yes,WIDTH=270');return false;" target="_phpbbsmilies" class="topictitle">{L_MORE_SMILIES}</a></span></td>
							</tr>
