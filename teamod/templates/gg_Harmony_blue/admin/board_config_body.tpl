...
<tr>
	<td height="25" class="row1">
		...
		<tr>
			...
			<td nowrap="nowrap" onMouseOver="this.style.cursor='pointer'; this.style.fontWeight='bold';" onMouseOut="this.style.cursor='pointer'; this.style.fontWeight='normal';" onClick="dom_menu.set('generalinfo'); return false;"><div id="generalinfo_opt" style="font-weight: bold;"><a href="javascript:dom_menu.set('generalinfo');" class="gensmall">{L_GENERAL_SETTINGS}</a></div></td>
		</tr>
		<tr>
			<td width="10" align="right"><div id="cookiesinfo_flag" class="gensmall">&raquo;</div></td>
			<td nowrap="nowrap" onMouseOver="this.style.cursor='pointer'; this.style.fontWeight='bold';" onMouseOut="this.style.cursor='pointer'; this.style.fontWeight='normal';" onClick="dom_menu.set('cookiesinfo'); return false;"><div id="cookiesinfo_opt" style="font-weight: bold;"><a href="javascript:dom_menu.set('cookiesinfo');" class="gensmall">{L_COOKIE_SETTINGS}</a></div></td>
		</tr>
		<tr>
			<td width="10" align="right"><div id="pminfo_flag" class="gensmall">&raquo;</div></td>
			<td nowrap="nowrap" onMouseOver="this.style.cursor='pointer'; this.style.fontWeight='bold';" onMouseOut="this.style.cursor='pointer'; this.style.fontWeight='normal';" onClick="dom_menu.set('pminfo'); return false;"><div id="pminfo_opt" style="font-weight: bold;"><a href="javascript:dom_menu.set('pminfo');" class="gensmall">{L_PRIVATE_MESSAGING}</a></div></td>
		</tr>
		<tr>
			<td width="10" align="right"><div id="basicinfo_flag" class="gensmall">&raquo;</div></td>
			<td nowrap="nowrap" onMouseOver="this.style.cursor='pointer'; this.style.fontWeight='bold';" onMouseOut="this.style.cursor='pointer'; this.style.fontWeight='normal';" onClick="dom_menu.set('basicinfo'); return false;"><div id="basicinfo_opt" style="font-weight: bold;"><a href="javascript:dom_menu.set('basicinfo');" class="gensmall">{L_ABILITIES_SETTINGS}</a></div></td>
		</tr>
		<tr>
			<td width="10" align="right"><div id="avatarinfo_flag" class="gensmall">&raquo;</div></td>
			<td nowrap="nowrap" onMouseOver="this.style.cursor='pointer'; this.style.fontWeight='bold';" onMouseOut="this.style.cursor='pointer'; this.style.fontWeight='normal';" onClick="dom_menu.set('avatarinfo'); return false;"><div id="avatarinfo_opt" style="font-weight: bold;"><a href="javascript:dom_menu.set('avatarinfo');" class="gensmall">{L_AVATAR_SETTINGS}</a></div></td>
		</tr>
		<tr>
			<td width="10" align="right"><div id="coppainfo_flag" class="gensmall">&raquo;</div></td>
			<td nowrap="nowrap" onMouseOver="this.style.cursor='pointer'; this.style.fontWeight='bold';" onMouseOut="this.style.cursor='pointer'; this.style.fontWeight='normal';" onClick="dom_menu.set('coppainfo'); return false;"><div id="coppainfo_opt" style="font-weight: bold;"><a href="javascript:dom_menu.set('coppainfo');" class="gensmall">{L_COPPA_SETTINGS}</a></div></td>
		</tr>
		<tr>
			<td width="10" align="right"><div id="emailinfo_flag" class="gensmall">&raquo;</div></td>
			<td nowrap="nowrap" onMouseOver="this.style.cursor='pointer'; this.style.fontWeight='bold';" onMouseOut="this.style.cursor='pointer'; this.style.fontWeight='normal';" onClick="dom_menu.set('emailinfo'); return false;"><div id="emailinfo_opt" style="font-weight: bold;"><a href="javascript:dom_menu.set('emailinfo');" class="gensmall">{L_EMAIL_SETTINGS}</a></div></td>
		</tr>
		</table>
	</td>
</tr>
...
</table><table id="cookiesinfo" border="0" cellpadding="3" cellspacing="1" width="100%" class="forumline">
	<tr>
