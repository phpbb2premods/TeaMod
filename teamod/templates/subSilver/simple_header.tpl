...
attachmod
*/
td.attachrow		{ border-color : {T_BODY_TEXT}; }
td.attachheader     { border-color : {T_BODY_TEXT}; background-color: {T_TR_COLOR3}; }
table.attachtable	{ border-color : {T_BODY_TEXT};	border-collapse : collapse; }
