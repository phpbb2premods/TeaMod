...
<form method="post" name="shadow_list" action="{S_ATTACH_ACTION}">
  ...
  <table width="100%" align="center" cellpadding="4" cellspacing="1" border="0" class="forumline">
	...
	<tr> 
	  <td class="row3" colspan="5" align="center"><span class="gensmall">{L_EXPLAIN_FILE}</span></td>
	</tr>
  ...
  <!-- END file_shadow_row -->
	...
	<tr> 
	  <td class="row3" colspan="5" align="center"><span class="gensmall">{L_EXPLAIN_ROW}</span></td>
	</tr>
