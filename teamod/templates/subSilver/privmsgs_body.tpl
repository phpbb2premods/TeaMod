	  ...
	  <table width="175" cellspacing="1" cellpadding="2" border="0" class="bodyline">
		...
		<tr> 
		  <td colspan="3" width="175" class="row2">
			<table cellspacing="0" cellpadding="1" border="0">
			  <tr> 
				<td bgcolor="{T_TD_COLOR2}"><img src="{I_SPACER}" width="{INBOX_LIMIT_IMG_WIDTH}" height="8" alt="{INBOX_LIMIT_PERCENT}" /></td>
			  </tr>
			</table>
		  </td>
		</tr>
...
{NAVIGATION_BOX}
  ...
  <table border="0" cellpadding="3" cellspacing="1" width="100%" class="forumline">
	...
	<tr> 
	  ...
	  <td width="55%" valign="middle" class="{listrow.ROW_CLASS}">{listrow.PRIVMSG_ATTACHMENTS_IMG}<span class="topictitle">&nbsp;<a href="{listrow.U_READ}" class="topictitle">{listrow.SUBJECT}</a></span><span class="gensmall">{listrow.SUB_TITLE}</span></td>
