...
<table border="0" cellpadding="4" cellspacing="1" width="100%" class="forumline">
  ...
  <tr> 
	...
	<td width="100%" class="row2"><span class="genmed">{POST_SUBJECT}</span><span class="gensmall">{POST_SUB_TITLE}</span></td>
  </tr>
  <tr> 
	<td valign="top" colspan="2" class="row1"><span class="postbody">{MESSAGE}<!-- BEGIN postrow -->{postrow.ATTACHMENTS}<!-- END postrow --></span>
	</td>
  </tr>
</table>
