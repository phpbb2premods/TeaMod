...
<table width="99%" cellpadding="4" cellspacing="1" border="0" align="center" class="forumline">
	<tr>
		<td class="catHead" colspan="2" align="center"><span class="cattitle">{L_SETTINGS_CAT_IMAGES}</span></td>
	</tr>
	<tr>
	  <th class="thHead" colspan="2">{L_ASSIGNED_GROUP}: {S_ASSIGNED_GROUP_IMAGES}</th>
	</tr>
	<tr>
