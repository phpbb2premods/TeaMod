...
{LAST_TOPICS}
<!-- BEGIN last_topics_spacing --><br class="nav" /><!-- END last_topics_spacing -->
...
<table width="100%" align="center" border="0" cellpadding="0" cellspacing="0" >
     <tr>
          	<td width="70" height="15"><img src="templates/IcE/images/cel-hg.jpg"></td>
            <td height="15" width="100%" background="templates/IcE/images/cell-fh.jpg"></td>
            <td width="64" height="15"><img src="templates/IcE/images/cell-hd.jpg"></td>
      </tr>
</table>
...
<tr>
	...
	<!-- BEGIN last_post -->
		<td class="{indexrow.forum.HYPERCELL_CLASS}-right"{indexrow.forum.HYPERCELL_LAST_ONCLICK} align="center" valign="middle" height="50" nowrap="nowrap"><span class="gensmall">
...
<tr>
	...
	<td class="{indexrow.link.HYPERCELL_CLASS}"{indexrow.link.HYPERCELL_ONCLICK} height="50" width="100%">
		<!-- BEGIN forum_icon -->
		<table cellpadding="0" cellspacing="0" width="100%" border="0"><tr>
...
<table width="100%" align="center" border="0" cellpadding="0" cellspacing="0">
	<tr>	
		<td width="70" height="15"><img src="templates/IcE/images/cell-bg.jpg"></td>
        <td height="15" width="100%" background="templates/IcE/images/cell-fb.jpg"></td>
        <td width="64" height="15"><img src="templates/IcE/images/cell-bd.jpg"></td>
     </tr>
</table>
<!-- END footer -->
...
<tr>
	...
	<tr>
		...
		<td class="gensmall">{L_CALENDAR}</td>
	</tr>
	<tr>
