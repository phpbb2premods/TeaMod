...
<tr>
	...
	<td class="{topicrow.HYPERCELL_CLASS}"{topicrow.HYPERCELL_ONCLICK} width="100%"><span class="topictitle">
	...
	<td class="<!-- BEGIN select -->{topicrow.HYPERCELL_CLASS}<!-- BEGINELSE select -->{topicrow.HYPERCELL_CLASS}-right<!-- END select -->"{topicrow.HYPERCELL_LAST_ONCLICK} align="center" valign="middle" nowrap="nowrap"><span class="postdetails">&nbsp;
