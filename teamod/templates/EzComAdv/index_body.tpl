...
<table width="100%" border="0" cellpadding="0" cellspacing="0">
           <tr><td width="11" height="11"><img src="templates/EzComAdv/images/coin_hg2.jpg"></td>
               <td height="11" width="100%" background="templates/EzComAdv/images/bordhau2.jpg"></td>
               <td width="11" height="11"><img src="templates/EzComAdv/images/coin_hd2.jpg"></td></tr>
               <tr>
...
<tr>
	...
	<td class="{indexrow.link.HYPERCELL_CLASS}"{indexrow.link.HYPERCELL_ONCLICK} height="50" width="100%">
		...
		<!-- END forum_icon -->
		<span class="forumlink"><a href="{indexrow.link.U_VIEWFORUM}" target="_blank" class="forumlink">{indexrow.link.FORUM_NAME}</a><br /></span>
...
<td width="11" background="templates/EzComAdv/images/borddroit2.jpg"></td>
	...
	<tr><td width="11" height="11"><img src="templates/EzComAdv/images/coin_bg2.jpg"></td>
